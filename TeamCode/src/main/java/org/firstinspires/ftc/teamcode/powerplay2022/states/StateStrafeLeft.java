...
public class StateStrafeLeft implements EbotsAutonState {
    ...
    public StateStrafeLeft(EbotsAutonOpMode autonOpMode){
        ...
        targetClicks = AllianceSingleton.isBlue() ? 1200 : 1200;
