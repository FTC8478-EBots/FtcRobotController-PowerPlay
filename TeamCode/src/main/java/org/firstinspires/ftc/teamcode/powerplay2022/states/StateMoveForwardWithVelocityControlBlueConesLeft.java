...
public class StateMoveForwardWithVelocityControlBlueConesLeft extends EbotsAutonStateVelConBase {


    public StateMoveForwardWithVelocityControlBlueConesLeft(EbotsAutonOpMode autonOpMode){
        super(autonOpMode);
