...
public class StateElevatorMedium implements EbotsAutonState {
    ...
    public StateElevatorMedium(EbotsAutonOpMode autonOpMode){
        ...
        elevator.moveToLevel(Elevator.Level.TWO);
    }
