...
public class StateElevatorCone4 implements EbotsAutonState {
    ...
    public StateElevatorCone4(EbotsAutonOpMode autonOpMode){
        ...
        elevator.moveToLevel(Elevator.Level.CONE_3);
    }
