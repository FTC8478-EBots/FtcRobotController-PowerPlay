...
public class StateElevatorCone1 implements EbotsAutonState {
    ...
    public StateElevatorCone1(EbotsAutonOpMode autonOpMode){
        ...
        elevator.moveToLevel(Elevator.Level.CONE_1);
    }
