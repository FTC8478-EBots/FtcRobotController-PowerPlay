...
public class StateStrafeLeft5WithVelocityControl extends EbotsAutonStateVelConBase {


    public StateStrafeLeft5WithVelocityControl(EbotsAutonOpMode autonOpMode){
        super(autonOpMode);
