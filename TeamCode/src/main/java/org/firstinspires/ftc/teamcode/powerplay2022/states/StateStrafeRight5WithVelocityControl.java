...
public class StateStrafeRight5WithVelocityControl extends EbotsAutonStateVelConBase {


    public StateStrafeRight5WithVelocityControl(EbotsAutonOpMode autonOpMode){
        super(autonOpMode);
