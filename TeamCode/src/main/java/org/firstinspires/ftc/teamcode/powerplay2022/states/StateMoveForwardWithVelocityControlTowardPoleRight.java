...
public class StateMoveForwardWithVelocityControlTowardPoleRight extends EbotsAutonStateVelConBase {


    public StateMoveForwardWithVelocityControlTowardPoleRight(EbotsAutonOpMode autonOpMode){
        super(autonOpMode);
