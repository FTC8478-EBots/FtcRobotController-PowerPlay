...
public class StateStrafeLeftWithVelocityControl extends EbotsAutonStateVelConBase {


    public StateStrafeLeftWithVelocityControl(EbotsAutonOpMode autonOpMode){
        super(autonOpMode);
