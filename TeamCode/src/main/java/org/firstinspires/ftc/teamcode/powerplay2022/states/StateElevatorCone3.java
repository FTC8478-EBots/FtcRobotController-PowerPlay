...
public class StateElevatorCone3 implements EbotsAutonState {
    ...
    public StateElevatorCone3(EbotsAutonOpMode autonOpMode){
        ...
        elevator.moveToLevel(Elevator.Level.CONE_4);
    }
